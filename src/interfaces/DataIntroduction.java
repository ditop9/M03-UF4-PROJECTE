...
public interface DataIntroduction {
    ...
    static void loadData() {
        ...
        c1.addNewVehicle(new Motorcycle("4392CDE", 'E', 2, 60, "Moto Esportiva", 15, 600));
        ...
        c2.addNewVehicle(new Motorcycle("2389PLM", 'G', 2, 80, "Moto Custom", 12, 500));
        ...
        c3.addNewVehicle(new Motorcycle("6709ZYX", 'G', 2, 70, "Moto Naked", 14, 400));
        ...
        c4.addNewVehicle(new Motorcycle("7531MNO", 'G', 2, 90, "Moto Sport-Turisme", 13, 750));
        ...
        w1.addNewVehicle(new Motorcycle("6423LMN", 'E', 2, 50, "Moto Sport-Turisme", 13, 500));
        ...
        w2.addNewVehicle(new Motorcycle("5174PQR", 'E', 2, 40, "Moto Custom", 12, 750));
        ...
        w3.addNewVehicle(new Motorcycle("7201VWX", 'G', 2, 60, "Moto Naked", 14, 400));
        ...
        w4.addNewVehicle(new Motorcycle("3067KLM", 'G', 2, 70, "Moto Scooter", 11, 300));
        ...
        w5.addNewVehicle(new Motorcycle("2783WXY", 'E', 2, 50, "Moto Sport-Turisme", 13, 500));
        w5.addNewVehicle(new Motorcycle("7149ZAB", 'E', 2, 40, "Moto Custom", 12, 750));
